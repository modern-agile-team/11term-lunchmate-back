...
export class InitSchema1774315045767 implements MigrationInterface {
    name = 'InitSchema1774315045767'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "post_categories" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, CONSTRAINT "PK_9c45c4e9fb6ebf296990e1d3972" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "post_likes" ("id" SERIAL NOT NULL, "user_id" integer, "post_id" integer, CONSTRAINT "UQ_8f64693922a9e8c4e2605850d0b" UNIQUE ("user_id", "post_id"), CONSTRAINT "PK_e4ac7cb9daf243939c6eabb2e0d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comments" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" SERIAL NOT NULL, "content" text NOT NULL, "like_count" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "comment_likes" ("id" SERIAL NOT NULL, "user_id" integer, "comment_id" integer, CONSTRAINT "PK_2c299aaf1f903c45ee7e6c7b419" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."friends_status_enum" AS ENUM('PENDING', 'ACCEPTED', 'REJECTED')`);
        await queryRunner.query(`CREATE TABLE "friends" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" SERIAL NOT NULL, "status" "public"."friends_status_enum" NOT NULL DEFAULT 'PENDING', "requester_id" integer, "receiver_id" integer, CONSTRAINT "UQ_ca7109a4de6bb73ecf3ed3f9d29" UNIQUE ("requester_id", "receiver_id"), CONSTRAINT "PK_65e1b06a9f379ee5255054021e1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."meal_menus_meal_type_enum" AS ENUM('BREAKFAST', 'LUNCH', 'DINNER', 'ALL')`);
        await queryRunner.query(`CREATE TABLE "meal_menus" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" SERIAL NOT NULL, "school_info" character varying(100) NOT NULL, "meal_date" date NOT NULL, "meal_type" "public"."meal_menus_meal_type_enum" NOT NULL, "menu_name" character varying(255) NOT NULL, "price" integer, "calorie" integer, "like_count" integer NOT NULL DEFAULT '0', "dislike_count" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_ca098e1265ce8bf547a3a89ea21" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."meal_menu_reactions_action_type_enum" AS ENUM('LIKE', 'DISLIKE')`);
        await queryRunner.query(`CREATE TABLE "meal_menu_reactions" ("id" SERIAL NOT NULL, "action_type" "public"."meal_menu_reactions_action_type_enum" NOT NULL, "user_id" integer, "meal_menu_id" integer, CONSTRAINT "UQ_d674c1cd4415f3cb4a98653ea4c" UNIQUE ("user_id", "meal_menu_id"), CONSTRAINT "PK_a0e17eee508c2afa16021cde494" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."rooms_room_type_enum" AS ENUM('MALE', 'FEMALE', 'ANY')`);
        await queryRunner.query(`CREATE TYPE "public"."rooms_status_enum" AS ENUM('OPEN', 'CLOSE')`);
        await queryRunner.query(`CREATE TABLE "rooms" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" SERIAL NOT NULL, "title" character varying(100) NOT NULL, "description" text, "room_type" "public"."rooms_room_type_enum" NOT NULL, "max_members_count" integer NOT NULL, "min_age" integer NOT NULL, "max_age" integer NOT NULL, "place" character varying(100) NOT NULL, "lunch_at" TIMESTAMP NOT NULL, "status" "public"."rooms_status_enum" NOT NULL DEFAULT 'OPEN', "current_count" integer NOT NULL DEFAULT '1', "user_id" integer, CONSTRAINT "PK_0368a2d7c215f2d0458a54933f2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "room_members" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer, "room_id" integer, CONSTRAINT "PK_4493fab0433f741b7cf842e6038" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_gender_enum" AS ENUM('MALE', 'FEMALE')`);
        await queryRunner.query(`CREATE TABLE "users" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" SERIAL NOT NULL, "email" character varying(100) NOT NULL, "nickname" character varying(50) NOT NULL, "hashed_password" character varying NOT NULL, "birth_date" date NOT NULL, "gender" "public"."users_gender_enum" NOT NULL, "school" character varying(100) NOT NULL, "introduce" text, "mbti" character varying(4), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_ad02a1be8707004cb805a4b5023" UNIQUE ("nickname"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "friends" ADD CONSTRAINT "FK_14fa620ed445b7565c492e67ff6" FOREIGN KEY ("receiver_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "meal_menu_reactions" ADD CONSTRAINT "FK_29edc27293fd665111a55274acd" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "meal_menu_reactions" ADD CONSTRAINT "FK_eae781899a78ae2fffd1fcb5912" FOREIGN KEY ("meal_menu_id") REFERENCES "meal_menus"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "room_members" ADD CONSTRAINT "FK_e6cf45f179a524427ddf8bacd8e" FOREIGN KEY ("room_id") REFERENCES "rooms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "meal_menu_reactions" DROP CONSTRAINT "FK_eae781899a78ae2fffd1fcb5912"`);
        await queryRunner.query(`ALTER TABLE "meal_menu_reactions" DROP CONSTRAINT "FK_29edc27293fd665111a55274acd"`);
        await queryRunner.query(`ALTER TABLE "friends" DROP CONSTRAINT "FK_14fa620ed445b7565c492e67ff6"`);
        ...
        await queryRunner.query(`DROP TABLE "meal_menu_reactions"`);
        await queryRunner.query(`DROP TYPE "public"."meal_menu_reactions_action_type_enum"`);
        await queryRunner.query(`DROP TABLE "meal_menus"`);
        await queryRunner.query(`DROP TYPE "public"."meal_menus_meal_type_enum"`);
